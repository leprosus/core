    ...
    private function refreshData() {
        ...
        if($this->isExist) {
            ...
            if($this->isFile) {
                ...
                $this->textPermissions .= (($perms & 0x0040) ? (($perms & 0x0800) ? 's' : 'x') : (($perms & 0x0800) ? 'S' : '-'));
                #Group
                $this->textPermissions .= (($perms & 0x0020) ? 'r' : '-');
                $this->textPermissions .= (($perms & 0x0010) ? 'w' : '-');
                $this->textPermissions .= (($perms & 0x0008) ? (($perms & 0x0400) ? 's' : 'x') : (($perms & 0x0400) ? 'S' : '-'));
                #World
                $this->textPermissions .= (($perms & 0x0004) ? 'r' : '-');
                $this->textPermissions .= (($perms & 0x0002) ? 'w' : '-');
                $this->textPermissions .= (($perms & 0x0001) ? (($perms & 0x0200) ? 't' : 'x') : (($perms & 0x0200) ? 'T' : '-'));
