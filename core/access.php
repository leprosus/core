...
final class Access{
     ...
     * @access public
     * @param int $lifetime Имя для сохранения данных в сессии
     * @return \Core\Access
     */
    public function setSessionName($sessionName){
        $this->sessionName = ucfirst($sessionName);
     ...
     * @access public
     * @param AcceessExtension $extension Название функции обработчика
     * @return \Core\Access
     */
    public function addExtension($extension){
        if($extension instanceof Extension\Acceess){
